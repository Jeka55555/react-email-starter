...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["admin-contact-sales"]},{"slug":["admin-new-company"]},{"slug":["approved-registration"]},{"slug":["eld-teamplate"]},{"slug":["reset-password"]},{"slug":["sign-up-confirmation"]},{"slug":["update-registration"]},{"slug":["components","LoginPageLink"]},{"slug":["components","PasswordLink"]},{"slug":["components","SupportEmail"]},{"slug":["components","SupportPhone"]},{"slug":["components","UserName"]},{"slug":["components","UserPassword"]}]
  );
}